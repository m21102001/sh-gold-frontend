    ...
    type: [
      {
        ...
        desc: `تقدم خدمة الاستشارات المالية في مجال الاستثمار في الذهب استشارات متخصصة تسمح بذلك يقوم 
        المستثمرون بتحليل الأسواق بدقة واتخاذ قرارات مستنيرة في شراء وبيع الذهب والمعادن الثمينة.        `,
      },
      {
        id: 2,
        ...
        desc: `نوفر استشارات مالية تساعد للأفراد والمؤسسات في فهم الأسواق واتخاذ قرارات استثمارية مستنيرة، مما يحد من المخاطر ويزيد من الفرص لتحقيق العائد المرجو . تقديم تحليل مستمر لألسواق المالية يساعد في فهم الاتجاهات وتوقع التطورات، مما يمكن المستثمرين من اتخاذ قرارات مستنيرة وفقًا للظروف الراهنة.
         `
      },
      {
        id: 3,
        ...
        desc: `تقديم استشارات تجارية تساعد المؤسسات في تطوير استراتيجياتها وتحسين أدائها التشغيلي، مما يؤدي إلى تحقيق المزيد من الربحية. مواجهة التحديات التجارية بشكل فعال .من خلال استشارات تساعد في التعامل مع التقلبات في السوق وتحسين الكفاءة التشغيلية تقديم استشارات مالية متقدمة للشركات ورجال الأعمال، تتناول تحليل األداء المالي، .وتطوير استراتيجيات النمو، وتحسين إدارة رؤوس األموال.`
      },
      {
        id: 4,
