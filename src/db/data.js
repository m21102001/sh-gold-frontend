    ...
    type: [
      {
        ...
        desc: `تقدم خدمة الاستشارات المالية في مجال الاستثمار في الذهب استشارات متخصصة تسمح للمثتسمر 
      ...
      },
      {
        ...
        desc: `نوفر استشارات مالية تساعد الأفراد والمؤسسات في فهم الأسواق واتخاذ قرارات استثمارية مستنيرة، مما يحد من 
        المخاطر ويزيد من الفرص لتحقيق العائد المرجو . تقديم تحليل مستمر للاسواق المالية يساعد على فهم
         الاتجاهات وتوقع التطورات، مما يمكن المستثمرين من اتخاذ قرارات مستنيرة وفقًا للظروف الراهنة.
         `
      },
      {
        id: 3,
